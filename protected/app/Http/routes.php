...
Route::post('/upload-foto-sekolah', 'GuruController@upload_foto_sekolah');
Route::post('/update-profil-sekolah', 'GuruController@update_profil_sekolah');

/*Route::controller('data-siswa', 'GuruController', [
    'anyData'  => 'data-siswa.data',
    'getIndex' => 'data-siswa',
]);*/
...
/*Route::controller('data-guru', 'DataguruController', [
    'anyData'  => 'data-guru.data',
    'getIndex' => 'data-guru',
]);*/
...
Route::post('/upload_file_audio', 'SoalController@upload_file_audio');
...
//     return View::make('/content')->with('users', $users)->render();
// });
